...
import { electronOpenDevtoolsWindow, electronOpenSettingsDevtools, electronShowOpenDialog } from '../../../../shared/eventa'
...
export async function setupSettingsWindowInvokes(params: {
  ...
  defineInvokeHandler(context, electronShowOpenDialog, async (options) => {
    const result = await dialog.showOpenDialog(params.settingsWindow, {
      title: options?.title,
